  ...
  <a-card>
    ...
    >
      ...
      <template #tags="{ record }">
        <a-space wrap size="mini" v-if="record.tags && record.tags.length">
          <a-tag v-for="(tag, i) in record.tags" :key="i" size="small">{{ tag }}</a-tag>
        </a-space>
...
const table = reactive({
  ...
  columns: [
    ...
    { dataIndex: 'tags', title: '标签', width: 150, slotName: 'tags', ellipsis: true },
